<template>
    <div class="f-daishouhuo-con">
        <div class="f-daishouhuo-order" v-if="number == 0">
        ...
        <div v-else class="f-daishouhuo-info">
            <div class="f-daifahuo-shop" :key="sid" v-for="(shop,sid) in AllorderInfo">
                <div class="f-daifahuo-title">
                    ...
                    <div class="f-shop-dec">物流运输中</div>
                </div>
    ...
    export default {
        ...
        methods:{
            _initAllOrderInfo(){
                ...
                fetch('http://119.3.133.207:5000/wait/good/?token='+token).then(res=>{
                    res.json().then(data => {
                        console.log(data)
