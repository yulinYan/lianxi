        ...
        methods:{
            ...
            setpwdSubmit(){
                if(this.confirm != this.content){
                    ...
                    fetch('http://119.3.133.207:5000/user/setpwd/',{
                        // 119.3.133.207
                        method:"POST",
                        mode: "cors",
                        headers:{
                        ...
                        body:JSON.stringify({phone:phone, password: this.content,re_password:this.confirm})
                    }).then(res=> {
                        return res.json();
                    }).then(data=>{
                        console.log(data);
...
<style scoped>
    ...
    .f-setpwd-set-box,.f-setpwd-confirm-box,.f-user-phone{
        width:98%;
        height:0.35rem;
    ...
    .f-setpwd-set,.f-setpwd-confirm,.f-setpwd-usephone{
   ...
   .f-setpwd-password,.f-confirm-password,.f-userphone{
        width:75%;
        height:0.35rem;
        border:none;
        outline: none;
